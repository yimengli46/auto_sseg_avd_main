...
def run_semantic_segmentation(scene):
    print(f'scene = {scene}')

    saved_folder = 'output/stage_f_sem_seg'
    ...
    stage_d_result_folder = f'output/stage_d_maskFormer_results/{scene}'
    ...
    for img_name in img_name_list[16:]:
...
def mp_run_wrapper(args):
    run_semantic_segmentation(args[0])
