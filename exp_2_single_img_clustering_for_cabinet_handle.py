"""
This script reads pre-generated image features for cabinet segments from a single image, applies 
...
for scene in scene_list:
    ...
    for img_name in img_name_list:
        ...
        # kmeans clustering
        kmeans = KMeans(n_clusters=num_classes, random_state=0, n_init="auto").fit(batch_feature)
